...
Thanks for helping improve 3d-livestream. The project is primarily tested with a Prusa CORE One and INDX toolchanger, so clearly identify assumptions about other printers, firmware, cameras, or OBS versions.
...
- Match the existing style: CommonJS for the main service and ES modules for `.mjs` tools.
...
- Preserve credential redaction and fail-closed behavior in operational tooling.
